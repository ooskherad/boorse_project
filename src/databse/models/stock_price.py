...
class StockPrice(BaseModel):
    ...
    price_yesterday: Mapped[int] = mapped_column(Integer)
    price_authorized_max: Mapped[int] = mapped_column(Integer)
    price_authorized_min: Mapped[int] = mapped_column(Integer)
